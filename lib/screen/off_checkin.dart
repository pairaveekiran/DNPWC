...
// ─══════════════════════════════════════════════════════════════════─
//  NOTE: Offline check-in/check-out functionality is coming soon.
//  The full implementation is preserved below (commented out) for
//  future use when offline mode is re-enabled.
// ─══════════════════════════════════════════════════════════════════─
...
class _OfflineScanScreenState extends State<OfflineScanScreen> {
  ...
  static const Color bgColor = Color(0xFFF4F7FC);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ─── Description ───
            const Text(
              "Offline check-in and check-out functionality is currently under development. You'll be able to scan permits, record entries, and sync data when back online.",
...
//  1. Delete the simplified _OfflineScanScreenState above (lines ~25-148)
//  2. Uncomment all code below
//  3. Add back the imports that are commented out below
...
//         backgroundColor: direction == 1 ? accentBlue : Color(0xFFC62828),
//         content: Text(
//           direction == 1
...
//         boxShadow: [
//           BoxShadow(
//             color: Color(0xFFE67E22).withValues(alpha: 0.08),
//             blurRadius: 10,
//             offset: Offset(0, 3),
//           ),
//         ],
...
//               boxShadow: [
//                 BoxShadow(
//                   color: Color(0xFFE67E22).withValues(alpha: 0.3),
//                   blurRadius: 8,
//                   offset: Offset(0, 3),
//                 ),
//               ],
...
//         color: Color(0xFFEEF2F8),
//         borderRadius: BorderRadius.circular(12),
//         border: Border.all(color: Color(0xFFCDD8EC)),
//       ),
//       child: Row(
//         mainAxisAlignment: MainAxisAlignment.spaceBetween,
//         children: [
